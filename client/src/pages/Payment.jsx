...
const Payment = () => {
    ...
    return (
        <div className={`mt-[20px] flex flex-col p-4 ${lightMode ? "bg-[#D3D3D9]" : "bg-[#1c1c24]"} rounded-[10px]`}>
            <h1 className={`font-epilogue font-bold sm:text-[25px] text-[18px] leading-[38px] ${lightMode ? "text-[#5C5C5C]" : "text-[#AAAAAA] "} text-center`}>Payment Temporarily Deactivated</h1>
